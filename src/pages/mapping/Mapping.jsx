      ...
      <main className="flex-1 flex flex-col mr-10 sm:mr-0">
        ...
        <div className="flex flex-col lg:flex-row flex-1">
          ...
          <div className="flex-1 p-4 md:p-6">
            <div className="bg-white rounded-xl shadow border border-gray-200 h-full min-h-[400px] lg:min-h-0 flex flex-col">
          ...
          <div className="w-full lg:w-96 p-4 md:p-6 bg-gray-50 lg:border-l border-gray-200 overflow-y-auto">
